  ...
  return (
    <header className={`glass-medical backdrop-blur-xl border-b border-medical-100/30 p-4 flex items-center justify-between w-full transition-all duration-300 ${!isCollapsed ? "pl-10" : "pl-8"}`}>
      ...
      <div className="flex items-center space-x-4">
        ...
        {showChatPopup && (
          <div ref={chatRef} className="absolute right-4 top-16 w-96 card-medical z-[70] animate-slide-down">
        ...
        <div className="relative">
          ...
          {showDropdown && (
            <div ref={dropdownRef} className="absolute right-0 mt-3 w-56 card-medical animate-slide-down z-[70]">
