      ...
      <div className="bg-gradient-to-r from-medical-500 to-medical-600 p-4 flex items-center justify-between">
        <div className="flex items-center space-x-4">
          <div className="relative">
            ...
            <div className={`absolute -bottom-1 -right-1 w-4 h-4 ${getOnlineStatusColor()} border-2 border-white rounded-full`}></div>
          </div>
          <div className="text-white">
            <h3 className="font-semibold">
              {contactInfo?.type === 'doctor' ? 'Dr. ' : ''}{contactInfo?.firstName} {contactInfo?.lastName}
            </h3>
        ...
        {messages.length > 0 ? (
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-sm text-neutral-500">Commencez la conversation en envoyant un message</p>
            </div>
          </div>
        )}
